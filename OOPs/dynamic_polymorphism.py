...
class ElectricCar(Car):
    ...
    def accelerate(self):
        ...
        print(f"{self._brand} {self._model} : Accelerating to {self._current_speed} km/h. Battery at {self._battery_level}%.")

    def brake(self):
        self._current_speed -= 15
        if self._current_speed < 0:
            self._current_speed = 0
        print(f"{self._brand} {self._model} : Regenerative braking! Speed is now {self._current_speed} km/h. Battery at {self._battery_level}%.")
